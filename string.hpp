...
//
// To use the supplied test oracles you will need to use this interface and
// namings. You must also have all of these methods and functions defined for
// your string class.
//
// You can NOT add any attributes/members.  If you do the test oracles will not
// work.
//
